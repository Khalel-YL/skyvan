        ...
        <div className="flex items-center gap-3 border-b border-zinc-800 px-6 py-4">
          ...
          <div className="flex-1 text-center">
            ...
            <h2 className="mt-1 text-lg font-semibold text-white">
              {initialData ? "Adayı düzenle" : "Yeni aday oluştur"}
            </h2>
          <p className="mt-1 text-xs text-zinc-400">
              Müşteri adayını proje sürümü ve iletişim durumu ile bağla.
            </p>
          </div>
        ...
        <form action={formAction} className="space-y-5 px-5 py-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              >
                <option value="">Proje sürümü seç</option>
          ...
          <label className="flex items-center gap-3 rounded-2xl border border-zinc-800 bg-zinc-900 px-3 py-2.5 text-sm text-zinc-300">
            <input
              type="checkbox"
              name="whatsappOptIn"
          ...
          <div className="flex items-center justify-end gap-3 border-t border-zinc-800 pt-4">
            ...
            <button
              type="submit"
              disabled={isPending}
              className="inline-flex items-center gap-2 rounded-full bg-white px-3 py-1.5 text-xs font-medium text-black transition hover:bg-zinc-200 disabled:cursor-not-allowed disabled:opacity-60"
            >
