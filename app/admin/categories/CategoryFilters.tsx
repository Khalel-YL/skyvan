...
function segmentedClass(
  current: "all" | CategoryStatus,
  value: "all" | CategoryStatus
) {
...
export function CategoryFilters() {
  ...
  const [status, setStatus] = useState<"all" | CategoryStatus>(
  ...
  function applyStatus(nextStatus: "all" | CategoryStatus) {
        ...
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="space-y-1">
            ...
            <div className="text-xs text-zinc-500">
              Kategorileri arama ve durum bilgisine göre daralt.
            </div>
          </div>
