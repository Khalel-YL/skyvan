...
export type EditorialReference = { label: string; description: string; href: string };
...
const tr: Record<CuratedPublicSlug, PublicEditorialCopy> = {
  ...
  muhendislik: {
    ...
    sections: [
      { id: "vehicle-context", heading: "İlk referans, aracın kendisi.", body: "Marka ve model yalnızca başlangıçtır. Model yılı, gövde tipi, varyant, alkovenli veya panelvan gövde kararı, kullanılabilir iç ölçüler, kapı ve pencere açıklıkları, aks yükleri ve toplam taşıma sınırı birlikte kayda alınır. L3, L4, H2 veya H3 etiketi bağlam sağlar; tek başına yerleşim uyumu göstermez." },
      { id: "material-weight-awareness", heading: "Malzeme ve ağırlık kararları birlikte izlenir.", body: "Skyvan’da kullanılan 15 mm Marin Panel için proje sahibinin verdiği 140 × 210 cm levha başına yaklaşık 15–16 kg bilgisi başlangıç verisidir. Kesim kaybı, bağlantı elemanları, kaplama, izolasyon ve donanım ayrıca eklenir. Her proje toplam kütleyi, aks dağılımını ve ağırlık merkezini doğrulanmış araç verisiyle yeniden kontrol eder.", bullets: ["Bir malzemeyi yalnızca levha ağırlığıyla değil, aynı işi yapan doğrulanmış eşdeğerlerle karşılaştırırız.", "Su depoları, aküler ve ekipmanlar boş/dolu durumlarıyla ayrı kütle kalemleri olarak izlenir."] },
      { id: "layout-physical-fit", heading: "Sığması kadar, kullanılabilmesi de önemli.", body: "Dolaşım genişliği, kapak ve çekmece açılımı, kablo bükülme yarıçapı, havalandırma, titreşim payı ve bakım boşluğu yerleşimin parçasıdır. Görselde boş görünen alan otomatik olarak kullanılabilir montaj alanı değildir; servis kapağı açılmıyorsa teknik olarak erişilebilir bir sistem de yoktur." },
      { id: "roof-electrical-compatibility", heading: "Çatı yerleşimi ve elektriksel uyum, iki ayrı soru.", body: "Gerçek panel ölçüsü, çatı eğriliği, gölgelenme, açıklıklar, yürüme ve servis payları fiziksel yerleşimi belirler. Elektrik tarafında Voc, Vmp, Isc ve dizi bağlantısı; MPPT’nin izin verdiği PV gerilimi/akımı, akünün şarj kabulü, kablo yolu ve koruma elemanlarıyla üretici dokümanına göre ayrıca doğrulanır. Panel wattı tek başına seçim kriteri değildir." },
      { id: "electrical-service", heading: "Elektrik dağıtımı erişilebilir ve anlaşılır kalmalı.", body: "Karavanın titreşimli ve nemli ortamında çok damarlı, esnek ve tercihen kalay kaplı marine bakır kablo yaklaşımı; doğru kesit, uygun klempleme ve mekanik sabitlemeyle birlikte ele alınır. Kablo kesiti yalnızca cihaz wattına bakılarak seçilmez: çalışma akımı, gidiş–dönüş toplam hat uzunluğu, ortam sıcaklığı, demetleme, izin verilen gerilim düşümü ve üretici/yerel kurallar birlikte değerlendirilir.", bullets: ["Sigorta veya devre kesici, kaynağa yakın konumlandırılarak kabloyu kısa devre enerjisinden korur; değeri kablo kesiti, yük ve üretici sınırı doğrulanmadan sabitlenmez.", "Dizi yapısı gerektiriyorsa combiner/string koruması; ardından PV ayırıcı, MPPT, MPPT çıkış koruması, akü/BMS, ana DC bara ve shunt/izleme noktaları işlevleri ayrıştırılmış, etiketli ve erişilebilir bir servis düzeninde tutulur.", "Alternatör–akü arasındaki DC–DC şarj yolu, marş sistemi ve yardımcı akü tarafında ayrı koruma ve üretici talimatıyla ele alınır; inverter/AC hattı ile DC güzergâhları gelişigüzel birleştirilmez."] },
      { id: "water-service", heading: "Su sistemi, bakım düşünülerek yerleşmeli.", body: "İçme suyu hattında gıda temasına uygun PEX, PEX-AL-PEX veya üreticisi tarafından onaylanmış esnek boru kullanımı; uygun rakor, kelepçe ve sızdırmazlık yöntemiyle birlikte değerlendirilir. “Pnömatik boru” ifadesi basınçlı hava içindir; burada doğru terim içme suyu tesisatıdır.", bullets: ["Temiz su deposu; havalandırma, temizleme ve seviye kontrolü erişilebilir olacak şekilde sabitlenir. Depo malzemesi ve iç yüzey, içme suyu kullanımına uygunluk belgesiyle doğrulanır.", "Depo çıkışında pompa giriş süzgeci, gerekiyorsa ayrı içme suyu filtresi, ardından talep kontrollü diyafram pompa; ihtiyaç varsa akümülatör/hidrofor basınç dalgalanmasını azaltacak biçimde konumlandırılır.", "Manifold; soğuk hattı, boiler/sıcak su kaynağını, karıştırma ve izolasyon noktalarını mobilya sökmeden görülebilir tutar. Hatlar basınç ve kaçak testinden sonra etiketlenir; filtre bakım aralığı kullanıcıya bırakılır.", "Temiz ve gri suyun araç içindeki konumu denge hedefiyle planlanır; “temiz sol, gri sağ” iyi bir başlangıç hipotezidir, fakat aks yükleri ve gerçek araç geometrisi doğrulanmadan evrensel kural değildir."] },
      { id: "controls", heading: "Temel işlevler anlaşılır kalsın.", body: "Enerji izleme, tank seviyesi, pompa ve ayırma noktaları kullanıcıya okunur bir arayüz sunmalıdır. Gösterge bir ölçüm sisteminin yerini tutmaz; devreye alma sırasında gerçek gerilim, akım, kaçak ve basınç testleri kayıt altına alınır. Servis paneli, sigorta ve vana erişimini kapatmayacak konumda olmalıdır." },
      { id: "technical-review", heading: "Teknik inceleme, açık soruları karara dönüştürür.", body: "Datasheet, montaj kılavuzu, araç ölçüsü, kablo güzergâhı, tank konumu ve varsayımlar aynı inceleme kaydında buluşur. Eksik bilgi varsa uygunluk çözülmemiş kalır; doğrulanmış kurallar kesin uyumsuzlukları ayırır, yapay zekâ ise nedeni açıklayıp soruları görünür kılar. Nihai teknik ve ticari karar insan onayıyla verilir." },
    ],
    note: "Bu sayfadaki şemalar konsept açıklamasıdır; ölçülü yerleşim, seçilmiş ürün veya montaj onayı değildir. Bilgi eksikse uygunluk sonucu da net değildir; nihai teknik ve ticari karar insan onayıyla verilir.",
    references: [
      { label: "Victron — Wiring Unlimited", description: "DC kablo seçimi, gerilim düşümü, sigorta, ayırma ve busbar için genel teknik referans.", href: "https://www.victronenergy.com/media/pg/The_Wiring_Unlimited_book/en/dc-wiring.html" },
      { label: "Blue Sea Systems — DC wire sizing", description: "Kablo kesiti ve devre korumasını akım, mesafe ve kurulum koşullarıyla birlikte ele alan referans.", href: "https://www.bluesea.com/support/articles/Circuit_Protection/1437/Part_1%3A_Choosing_the_Correct_Wire_Size_for_a_DC_Circuit" },
  ...
  workshop: {
    ...
    heading: "Bir ürün seçmezsiniz. Bir sistem kurarsınız.", body: "Atölye; seçtiğiniz aracın içinde enerji, su, malzeme, ağırlık ve kontrol kararlarını gerçek ürün verileriyle birlikte görmenizi sağlar. Deneyim şu anda hazırlanıyor.", status: "Yakında",
    sections: [
...
const en: Record<CuratedPublicSlug, PublicEditorialCopy> = {
  ...
  muhendislik: {
    ...
    sections: [
      { id: "vehicle-context", heading: "Begin with the vehicle itself.", body: "Make and model are only the starting point. Model year, body type, variant, the choice between an overcab motorhome and a panel-van conversion, usable interior dimensions, openings, axle loads and total payload are recorded together. L2/L3/L4 or H2/H3 labels add context; they do not establish layout compatibility." },
      { id: "material-weight-awareness", heading: "Material and weight decisions stay connected.", body: "For the 15 mm Marin Panel used by Skyvan, the project owner supplied an approximate 15–16 kg weight for a 140 × 210 cm sheet. Cut waste, fasteners, finish, insulation and equipment are added separately. Each project rechecks total mass, axle distribution and centre of gravity against verified vehicle data.", bullets: ["Materials are compared with verified equivalents that perform the same job, not with an isolated sheet weight.", "Tanks, batteries and equipment are tracked in empty and full/operating states."] },
      { id: "layout-physical-fit", heading: "Space to fit, and space to function.", body: "Circulation width, door and drawer movement, cable bend radius, ventilation, vibration allowance and maintenance clearance all affect the layout. Empty-looking space in a rendering is not automatically installation space; if a service panel cannot open, the system is not serviceable." },
      { id: "roof-electrical-compatibility", heading: "Roof placement and electrical compatibility are separate questions.", body: "Actual panel dimensions, roof curvature, shading, openings, walking and service clearances establish physical placement. Electrically, Voc, Vmp, Isc and array wiring are checked against the MPPT’s permitted PV voltage/current, the battery’s charge acceptance, cable route and protection using the manufacturer’s documentation. Panel wattage alone is not a selection rule." },
      { id: "electrical-service", heading: "Electrical distribution should remain accessible and understandable.", body: "In a vibrating, humid motorhome environment, flexible stranded and preferably tinned marine copper cable is considered together with the correct cross-section, crimping and mechanical restraint. Cable size is not chosen from appliance watts alone: operating current, total positive-and-negative run length, ambient temperature, bundling, acceptable voltage drop and manufacturer/local rules all matter.", bullets: ["A fuse or breaker close to the source protects the conductor from short-circuit energy; its rating is not fixed before cable, load and manufacturer limits are checked.", "When the array calls for it, string/combiner protection is followed by a PV isolator, MPPT, MPPT output protection, battery/BMS, main DC bus and shunt/monitor points, separated by function, labelled and reachable for service.", "The alternator-to-house-battery DC–DC path is protected on both sides and follows the product manual; inverter/AC and DC routes are not casually combined."] },
      { id: "water-service", heading: "Plan water systems around maintenance as well as use.", body: "Potable water uses food-contact-approved PEX, PEX-AL-PEX or manufacturer-approved flexible tubing, with compatible fittings, clamps and sealing methods. “Pneumatic pipe” describes compressed-air service; the correct category here is potable-water plumbing.", bullets: ["The fresh tank remains fixed and reachable for venting, cleaning and level inspection. Tank material and internal surfaces are verified for potable-water use.", "A pump-inlet strainer and, when required, a separate potable-water filter sit at the tank outlet before a demand diaphragm pump; an accumulator/hydrofor can reduce pressure cycling when the selected system calls for it.", "The manifold keeps the cold line, boiler/hot-water source, mixing and isolation points visible without dismantling furniture. Lines are pressure- and leak-tested, then labelled; filters remain service items.", "Fresh and grey tanks are planned against balance targets. ‘Fresh left, grey right’ is a starting hypothesis, not a universal rule before axle loads and vehicle geometry are verified."] },
      { id: "controls", heading: "Keep essential functions understandable.", body: "Energy monitoring, tank level, pump and isolation points should give the user a readable interface. A display is not a substitute for commissioning: real voltage, current, leakage and pressure tests are recorded. The service panel must not block fuse or valve access." },
      { id: "technical-review", heading: "Technical review turns open questions into accountable decisions.", body: "Datasheets, installation manuals, vehicle measurements, cable routes, tank locations and assumptions meet in one review record. When information is missing, compatibility remains unresolved; validated rules separate confirmed incompatibilities, while AI explains the reason and surfaces questions. Final technical and commercial decisions require human approval." },
    ], note: "These diagrams explain the concept; they are not scaled layouts, selected products or installation approvals. Missing information means compatibility is unresolved; final technical and commercial decisions require human approval.",
    references: [
      { label: "Victron — Wiring Unlimited", description: "General reference for DC cable selection, voltage drop, fuses, isolation and busbars.", href: "https://www.victronenergy.com/media/pg/The_Wiring_Unlimited_book/en/dc-wiring.html" },
      { label: "Blue Sea Systems — DC wire sizing", description: "A reference for considering conductor size and circuit protection with current, length and installation conditions.", href: "https://www.bluesea.com/support/articles/Circuit_Protection/1437/Part_1%3A_Choosing_the_Correct_Wire_Size_for_a_DC_Circuit" },
      { label: "Truma — Water systems in motorhomes", description: "Manufacturer guidance for understanding tanks, pumps, pressure and distribution in motorhomes.", href: "https://www.truma.com/gb/truma-guides/water-systems-in-motor-homes-and-caravans/" },
      { label: "REHAU — RAUTITAN", description: "Product documentation for a potable-water pipe and fitting system approach.", href: "https://water.rehau.com/uk-en/solutions-for-building-technology/plumbing-and-drinking-water/supply-lines/rautitan" },
    ], actions: [{ label: "Explore the Workshop Approach", slug: "workshop" }, { label: "Preparing for Production", slug: "uretim-sureci" }],
  },
  workshop: {
    ...
    heading: "You do not choose a product. You build a system.", body: "Workshop will show how energy, water, material, mass and control decisions behave inside the vehicle you choose, using real product data. The experience is now being prepared.",
    sections: [
      { id: "vehicle-selection", heading: "Set the body type before the dimensions.", body: "The planned journey will begin by clarifying whether you want an overcab motorhome or a direct panel-van conversion. Make, model, model year, body and variant then put L2/L3/L4 and H2/H3 classes into context. Verified usable dimensions will keep it clear which vehicle each choice is being considered for." },
      { id: "project-foundation", heading: "Describe your journey and living priorities.", body: "The project context will grow from how you travel and want to use the space. Seating, sleeping, galley, bathroom, storage, work and privacy needs will be considered within the same living brief, so each visible choice has an everyday reason." },
      { id: "category-choices", heading: "Explore product categories through their relationships.", body: "Workshop is intended to explain how a material choice affects mass, how battery chemistry affects energy and service conditions, how tank placement affects balance, how panel count affects roof space, and how every component affects maintenance access. Options without a verified product datasheet and vehicle context will not be presented as settled answers.", bullets: ["Material choice: mass, cutting and restraint implications.", "Energy choice: panel, MPPT, battery, DC–DC and protection chain.", "Water choice: tank, filter, pump, manifold and service access."] },
      ...
      { id: "technical-validation", heading: "Validate physical placement and technical compatibility separately.", body: "Four 205 W half-cut panels are an illustrative 820 W array example only; the number is neither a recommendation nor a vehicle-fit result. When Workshop opens, the system is intended to compare panel datasheets, roof geometry and the electrical chain in one validation record.", bullets: ["Do the panels physically fit the usable roof while preserving openings and service clearances?", "Are Voc, Vmp and Isc, the array wiring, the selected MPPT’s PV limits and the battery’s acceptable charge current compatible?", "Have cable cross-section, DC isolation, fuse/combiner and DC–DC routing been checked against the relevant manuals?", "When data is missing, AI does not invent a value; it explains which datasheet or measurement is needed. Deterministic rules can block confirmed incompatibilities, while final approval remains human."] },
      { id: "project-sealing", heading: "Seal a scope that is ready for review.", body: "Selections, total mass and centre of gravity, energy/water summary, warnings and open questions will meet in a shared project summary. A balance target such as fresh water left and grey water right is not a sealed decision until axle loads and real vehicle geometry are verified. Sealing the project will not mean automatic approval; final technical and commercial decisions will require human review." },
