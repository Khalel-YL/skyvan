...
const tr: Record<CuratedPublicSlug, PublicEditorialCopy> = {
  ...
  muhendislik: {
    ...
    sections: [
      ...
      { id: "electrical-service", heading: "Elektrik dağıtımı erişilebilir ve anlaşılır kalmalı.", body: "Karavanın titreşimli ve nemli ortamında çok damarlı, esnek ve tercihen kalay kaplı marine bakır kablo yaklaşımı; doğru kesit, uygun klempleme ve mekanik sabitlemeyle birlikte ele alınır. Kablo kesiti yalnızca cihaz wattına bakılarak seçilmez: çalışma akımı, gidiş–dönüş toplam hat uzunluğu, ortam sıcaklığı, demetleme, izin verilen gerilim düşümü ve üretici/yerel kurallar birlikte değerlendirilir.", bullets: ["Sigorta veya devre kesici, kaynağa yakın konumlandırılarak kabloyu kısa devre enerjisinden korur; değeri kablo kesiti, yük ve üretici sınırı doğrulanmadan sabitlenmez.", "Combiner kutusu, DC ayırıcı, MPPT, akü sigortası, DC bara ve shunt/izleme noktaları işlevleri ayrıştırılmış, etiketli ve erişilebilir bir servis düzeninde tutulur.", "Alternatör–akü arasındaki DC–DC şarj yolu, marş sistemi ve yardımcı akü tarafında ayrı koruma ve üretici talimatıyla ele alınır; AC ve DC güzergâhları gelişigüzel birleştirilmez."] },
      { id: "water-service", heading: "Su sistemi, bakım düşünülerek yerleşmeli.", body: "İçme suyu hattında gıda temasına uygun PEX, PEX-AL-PEX veya üreticisi tarafından onaylanmış esnek boru kullanımı; uygun rakor, kelepçe ve sızdırmazlık yöntemiyle birlikte değerlendirilir. “Pnömatik boru” ifadesi basınçlı hava içindir; burada doğru terim içme suyu tesisatıdır.", bullets: ["Temiz su deposu; havalandırma, temizleme ve seviye kontrolü erişilebilir olacak şekilde sabitlenir. Depo malzemesi ve iç yüzey, içme suyu kullanımına uygunluk belgesiyle doğrulanır.", "Depo çıkışında süzgeç/strainer ve değiştirilebilir filtre, ardından talep kontrollü diyafram pompa; ihtiyaç varsa akümülatör/hidrofor basınç dalgalanmasını azaltacak biçimde konumlandırılır.", "Manifold, izolasyon vanaları ve her bağlantı noktası mobilya sökmeden görülebilir kalır. Hatlar basınç ve kaçak testinden sonra etiketlenir; filtre bakım aralığı kullanıcıya bırakılır.", "Temiz ve gri suyun araç içindeki konumu denge hedefiyle planlanır; “temiz sol, gri sağ” iyi bir başlangıç hipotezidir, fakat aks yükleri ve gerçek araç geometrisi doğrulanmadan evrensel kural değildir."] },
...
const en: Record<CuratedPublicSlug, PublicEditorialCopy> = {
  ...
  muhendislik: {
    ...
    ], note: "Missing information means compatibility is unresolved. Technical review makes open questions visible; final technical and commercial decisions require human approval.",
    references: [
