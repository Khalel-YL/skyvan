...
export const adminNavItems: AdminNavItem[] = [
  ...
  {
    title: "Workshop Varlıkları",
    href: "/admin/workshop-assets",
    description: "Ürün, model ve 2.5D görsel katmanları",
    icon: Layers3,
    enabled: true,
    section: "stable",
    group: "engineering-core",
  ...
  },
  {
    title: "AI Core",
    href: "/admin/ai-core",
    description: "Yönetim ve bilgi hazırlığı görünürlüğü",
    icon: Bot,
    enabled: true,
    section: "stable",
    group: "intelligence-governance",
  },
  {
    title: "İz ve Yayın",
    href: "/admin/audit",
    description: "İz kayıtları ve yayın izi görünürlüğü",
    icon: ShieldCheck,
    enabled: true,
    section: "stable",
    group: "intelligence-governance",
